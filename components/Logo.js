...
const Logo = ({ isLight }) => (
  <Outer isLight={isLight}>
    <svg
      version="1.1"
      xmlns="http://www.w3.org/2000/svg"
      x="0px"
      y="0px"
      viewBox="0 0 300 40.2"
      style={{ enableBackground: 'new 0 0 300 40.2' }}
      xmlSpace="preserve"
    >
      <g id="XMLID_199_">
        <path
          className="name"
          d="M3.5,10.5h23.2c1.3,0,2.3,0.7,3.1,2.2c0.2,0.5,0.2,0.8,0.2,1.1v0.8c0,1.2-0.7,2.2-2.2,3
        ...
        />
        <rect x="257.4" className="square" width="7.7" height="7.7" />
        <circle className="circle" cx="103" cy="3.8" r="3.8" />
        <path
          className="triangle"
          d="M47.1,31.1c-1.4,2.9-2.7,5.5-3.8,7.7H51C49.1,35,47.1,31.1,47.1,31.1z"
        />
      </g>
    </svg>
  </Outer>
...
const Outer = styled.div`
  svg {
    ...
    height: 40px;
    .name {
      fill: ${props => (props.isLight ? 'white' : colors.font)};
      transition: 0.6s;
    }
    .square {
      fill: #ff0000;

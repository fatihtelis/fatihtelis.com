...
})(["transition:0.3s;line-height:1;white-space:nowrap;.name{font-size:32px;", ";}.title{font-size:14px;font-weight:300;letter-spacing:0.6px;}"], _style_theme__WEBPACK_IMPORTED_MODULE_7__["media"].phone(_templateObject()));
...
})(["position:absolute;bottom:0;right:0;width:200px;height:200px;z-index:120;opacity:0;pointer-events:none;transition:0.2s;cursor:alias;", ";.fold{", ";background:url('/static/page-curl/fold.png') center/contain no-repeat;z-index:2;}.code{", ";background:url('/static/page-curl/code.png') center/contain no-repeat;z-index:1;}&.active{opacity:1;pointer-events:visible;}"], _style_theme__WEBPACK_IMPORTED_MODULE_7__["media"].tablet(_templateObject2()), Object(_style_theme__WEBPACK_IMPORTED_MODULE_7__["cover"])(), Object(_style_theme__WEBPACK_IMPORTED_MODULE_7__["cover"])());
...
//# sourceMappingURL=index.js.77aa8c697ebf560a0098.hot-update.js.map
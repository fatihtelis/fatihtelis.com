...
})(["position:absolute;bottom:0;right:0;width:240px;height:240px;background:url('/static/page-curl/fold2.png') center/contain no-repeat;z-index:120;opacity:0;pointer-events:none;transition:0.2s;cursor:alias;", ";&::before{content:'';position:absolute;background:url('/static/page-curl/code.png') center/contain no-repeat;top:12.5%;left:12.5%;bottom:0;right:0;}&.active{opacity:1;pointer-events:visible;}"], _style_theme__WEBPACK_IMPORTED_MODULE_7__["media"].tablet(_templateObject()));
...
//# sourceMappingURL=index.js.aea4c0b42550225ab924.hot-update.js.map
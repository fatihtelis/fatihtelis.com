...
})(["transition:0.3s;line-height:1;white-space:nowrap;.name{font-size:32px;", ";}.title{font-size:14px;font-weight:300;letter-spacing:0.6px;", ";}"], _style_theme__WEBPACK_IMPORTED_MODULE_7__["media"].phone(_templateObject()), _style_theme__WEBPACK_IMPORTED_MODULE_7__["media"].phone(_templateObject2()));
var Menu = styled_components__WEBPACK_IMPORTED_MODULE_1__["default"].ul.withConfig({
  displayName: "pages__Menu",
  componentId: "mwjthg-2"
})(["padding-left:0;display:flex;align-items:center;padding:0;margin:0;", ";li{list-style-type:none;padding:0 30px;transition:0.3s;transform-origin:center;display:flex;align-items:center;justify-content:flex-end;font-size:18px;", ";button{position:relative;background-color:transparent;border:none;outline:unset;display:flex;cursor:pointer;transition:0.3s;.bx{position:absolute;right:-5px;top:-5px;font-size:12px;opacity:0;&.active{opacity:1;}}}}&.selected{li{transition:0.6s;&:not(.active){opacity:0.5;cursor:not-allowed;text-decoration:line-through;button{pointer-events:none;}}&.active{opacity:1;transform:scale(1.2);}button{color:white;transition:0.3s 0.3s;}}}"], _style_theme__WEBPACK_IMPORTED_MODULE_7__["media"].phone(_templateObject3()), _style_theme__WEBPACK_IMPORTED_MODULE_7__["media"].phone(_templateObject4()));
...
})(["position:absolute;bottom:0;right:0;width:200px;height:200px;z-index:120;opacity:0;pointer-events:none;transition:0.2s;cursor:alias;", ";.fold{", ";background:url('/static/page-curl/fold.png') center/contain no-repeat;z-index:2;}.code{", ";background:url('/static/page-curl/code.png') center/contain no-repeat;z-index:1;}&.active{opacity:1;pointer-events:visible;}"], _style_theme__WEBPACK_IMPORTED_MODULE_7__["media"].tablet(_templateObject5()), Object(_style_theme__WEBPACK_IMPORTED_MODULE_7__["cover"])(), Object(_style_theme__WEBPACK_IMPORTED_MODULE_7__["cover"])());
...
//# sourceMappingURL=index.js.17018bb1a26f58e3a273.hot-update.js.map
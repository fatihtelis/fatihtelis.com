...
})(["padding-left:0;display:flex;align-items:center;padding:0;margin:0;", ";li{list-style-type:none;padding:0 30px;transition:0.3s;transform-origin:center;display:flex;align-items:center;justify-content:flex-end;font-size:18px;", ";button{position:relative;background-color:transparent;border:none;outline:unset;display:flex;cursor:pointer;transition:0.3s;.bx{position:absolute;right:-5px;top:-5px;font-size:12px;opacity:0;&.active{opacity:1;}}}}&.selected{li{transition:0.6s;&:not(.active){opacity:0.5;cursor:not-allowed;text-decoration:line-through;", ";button{pointer-events:none;}}&.active{opacity:1;transform:scale(1.2);}button{color:white;transition:0.3s 0.3s;}}}"], _style_theme__WEBPACK_IMPORTED_MODULE_7__["media"].phone(_templateObject4()), _style_theme__WEBPACK_IMPORTED_MODULE_7__["media"].phone(_templateObject5()), _style_theme__WEBPACK_IMPORTED_MODULE_7__["media"].phone(_templateObject6()));
...
})(["position:absolute;bottom:0;right:0;width:200px;height:200px;z-index:120;opacity:0;pointer-events:none;transition:0.2s;cursor:alias;", ";.fold{", ";background:url('/static/page-curl/fold.png') center/contain no-repeat;z-index:2;}.code{", ";background:url('/static/page-curl/code.png') center/contain no-repeat;z-index:1;}&.active{opacity:1;pointer-events:visible;}"], _style_theme__WEBPACK_IMPORTED_MODULE_7__["media"].tablet(_templateObject7()), Object(_style_theme__WEBPACK_IMPORTED_MODULE_7__["cover"])(), Object(_style_theme__WEBPACK_IMPORTED_MODULE_7__["cover"])());
...
//# sourceMappingURL=index.js.fbf71b6184a3fd8f6179.hot-update.js.map